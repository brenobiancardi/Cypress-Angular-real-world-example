# Utilizando Cypress para testar aplicações Angular

Este repositório se refere a um projeto desenvolvido durante o Bootcamp Avanade FullStack Developer, onde em 10 aulas foi ensinado como testar uma aplicação frontend com o Cypress.

## Objetivo do repositório

1. Aprimorar conhecimentos em TDD.

1. Aprender a utilizar o Cypress para automatizar testes.

1. Aprimorar conhecimentos em desenvolvimendo frontend.

1. Aprimorar conhecimentos em git.

1. Aprimorar habilidades de desenvolvimento frontend usando o framework Angular
